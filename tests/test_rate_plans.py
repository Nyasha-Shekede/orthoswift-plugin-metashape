...
def physical(**updates):
    values = dict(
        ...
        rate_basis="product",
        unit="KG_HA",
        strategy="explicit_by_zone",
        zone_rates={0: 120, 1: 150, 2: 180},
        equipment_min_rate=100,
        equipment_max_rate=200,
...
def test_generic_and_deere_packages_validate(tmp_path):
    ...
    deere = export_vra_shapefile_zip(
        rx, tmp_path / "deere.zip", packaging_profile="john_deere_rx"
    )
