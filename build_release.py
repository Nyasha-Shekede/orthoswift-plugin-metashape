...
def main() -> None:
    ...
    versioned_name = f"orthoswift-metashape-plugin-v{version}.zip"
    versioned_archive = dist / versioned_name

    print(f"Building Metashape plugin release: {versioned_name}")
    ...
    generic_name = "orthoswift-metashape-plugin.zip"
